/**
 * Creates <a href="..." name="..."><a/> DOM node with href and name attribute.
 * @returns {HTMLElement}
 * */
...
/**
 * Create <li class="...">...</li> DOM node with class and text content attribute.
 * @returns {HTMLElement}
 * */
...
/**
 * Create <span class="..."></span> DOM node with class attribute.
 * @returns {HTMLElement}
 * */
